...
if (isset ($_POST['name'])  && isset($_POST['email']) && isset ($_POST['birthdate']) && isset ($_POST['city']) ) {
  ...
  $city = $_POST['city'];
  $sql = 'INSERT INTO personne(name, email,birthdate,city) VALUES(:name, :email,:birthdate,:city)';
  $statement = $connection->prepare($sql);
  if ($statement->execute([':name' => $name, ':email' => $email, ':birthdate' => $birthdate,':city' => $city,])) {
    ...
    <div class="card-body">
      ...
      <form method="post">
        ...
        <div class="form-group">
          ...
          <input type="date" placeholder="Enter your birthday" name="birthdate" id="birthdate" class="form-control">
        </div>
        <div class="form-group">
